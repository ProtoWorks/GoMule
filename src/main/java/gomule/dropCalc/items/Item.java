...
public class Item {
    ...
    Map<Object, Object> mDrops = new HashMap<>();
        ...
        switch (ItemClass) {
            case 0:
                ...
                for (int x = 0; x < D2TxtFile.WEAPONS.getRowSize(); x++) {
                    if (!D2TxtFile.WEAPONS.getRow(x).get("level").equals("") && !D2TxtFile.WEAPONS.getRow(x).get("level").equals("0") && Integer.parseInt(D2TxtFile.WEAPONS.getRow(x)
                                                                                                                                                                           .get("level")) + (3 - (Integer
                            .parseInt(D2TxtFile.WEAPONS.getRow(x).get("level")) % 3)) % 3 == ItemTC) {
            ...
            case 1:
                ...
                for (int x = 0; x < D2TxtFile.ARMOR.getRowSize(); x++) {
                    if (!D2TxtFile.ARMOR.getRow(x).get("level").equals("") && !D2TxtFile.ARMOR.getRow(x).get("level").equals("0") && Integer.parseInt(D2TxtFile.ARMOR.getRow(x)
                                                                                                                                                                     .get("level")) + (3 - (Integer.parseInt(
                            D2TxtFile.ARMOR.getRow(x).get("level")) % 3)) % 3 == ItemTC) {
