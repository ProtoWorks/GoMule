...
public class DCNew {
                    ...
                    for (int y = 0; y < mTuples.size(); y = y + 1) {
                        ...
                        if (((Monster) mainSupUniqArray.get(x)).getMonID().startsWith("Baal Subject")) {
                            ((MonsterTuple) mTuples.get(y)).lookupBASETCReturnATOMICTCS(nPlayers,
                                                                                        nGroup,
                                                                                        generateRarityList((MonsterTuple) mTuples.get(y), item) * getQuality(item,
                                                                                                                                                             ((MonsterTuple) mTuples.get(y)).getLevel(),
                                                                                                                                                             MF,
                                                                                                                                                             ((MonsterTuple) mTuples.get(y)),
                                                                                                                                                             QRecursions,
                                                                                                                                                             true),
                                                                                        sevP);
                            if (((MonsterTuple) mTuples.get(y)).getFinalTCs().containsKey(key)) {
                            ...
                            ((MonsterTuple) mTuples.get(y)).lookupBASETCReturnATOMICTCS(nPlayers,
                                                                                        nGroup,
                                                                                        d * generateRarityList((MonsterTuple) mTuples.get(y), item) * getQuality(item,
                                                                                                                                                                 ((MonsterTuple) mTuples.get(y)).getLevel(),
                                                                                                                                                                 MF,
                                                                                                                                                                 ((MonsterTuple) mTuples.get(y)),
                                                                                                                                                                 QRecursions,
    ...
    private void populateItemArrays() {
        ...
        for (int x = 0; x < D2TxtFile.MISC.getRowSize(); x++) {
            if (D2TxtFile.MISC.getRow(x).get("code").startsWith("cm") || D2TxtFile.MISC.getRow(x).get("type").equals("jewl") || D2TxtFile.MISC.getRow(x)
                                                                                                                                              .get("type")
                                                                                                                                              .equals("rune") || D2TxtFile.MISC.getRow(x)
                                                                                                                                                                               .get("code")
                                                                                                                                                                               .equals("amu") || D2TxtFile.MISC
                    .getRow(x)
                    .get("code")
                    .equals("rin") || !D2TxtFile.MISC.getRow(x).get("type2").equals("")) {
    ...
    public void populateArrays() {
        ...
        for (int x = 0; x < D2TxtFile.MONSTATS.getRowSize(); x = x + 1) {
            ...
            if (!D2TxtFile.MONSTATS.getRow(x).get("boss").equals("1") && D2TxtFile.MONSTATS.getRow(x).get("enabled").equals("1") && D2TxtFile.MONSTATS.getRow(x)
                                                                                                                                                      .get("killable")
                                                                                                                                                      .equals("1") && !D2TxtFile.MONSTATS.getRow(x)
                                                                                                                                                                                         .get("TreasureClass1")
                                                                                                                                                                                         .equals("") && !D2TxtFile.MONSTATS
                    .getRow(x)
                    .get("TreasureClass1(N)")
                    .equals("")) {
            ...
            } else if (D2TxtFile.MONSTATS.getRow(x).get("boss").equals("1") && D2TxtFile.MONSTATS.getRow(x).get("enabled").equals("1") && D2TxtFile.MONSTATS.getRow(x)
                                                                                                                                                            .get("killable")
                                                                                                                                                            .equals("1") && !D2TxtFile.MONSTATS.getRow(x)
                                                                                                                                                                                               .get("TreasureClass1")
                                                                                                                                                                                               .equals("") && !D2TxtFile.MONSTATS
