...
public class D2ViewStash extends JInternalFrame implements D2ItemContainer, D2ItemListListener {
    ...
    private RandallPanel getButtonPanel() {
        ...
        iDropOne.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent pEvent) {
                iStash.addItem(D2ViewClipboard.removeItem());
            }
        });
        ...
        iDeleteDups.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent pEvent) {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        iStash.addItem(((D2Item) lItemList.get(it.next())));
                    }
    ...
    private class D2StashFilter implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent pEvent) {
            ...
            if ((iCatSockAll.isSelected() && iCatSock1.isSelected()) || (iCatSockAll.isSelected() && iCatSock2.isSelected()) || (iCatSockAll.isSelected() && iCatSock3.isSelected()) || (iCatSockAll.isSelected() && iCatSock4
                    .isSelected()) || (iCatSockAll.isSelected() && iCatSock5.isSelected()) || (iCatSockAll.isSelected() && iCatSock6.isSelected())) {
            ...
            if ((iQualAll.isSelected() && iQualNorm.isSelected()) || (iQualAll.isSelected() && iQualExce.isSelected()) || (iQualAll.isSelected() && iQualEli.isSelected()) || (iQualAll.isSelected() && iQualOther
                    .isSelected())) {
