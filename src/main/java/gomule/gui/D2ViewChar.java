...
public class D2ViewChar extends JInternalFrame implements D2ItemContainer, D2ItemListListener {
                ...
                if (event.getActionCommand().equals("View Item")) {
                    ...
                    if (lItemPanel.getPanel() != -1) {
                        ...
                        if (lItemPanel.isItem()) {
                            ...
                            itemPanel.setLocation((rightClickEvent.getComponent().getLocationOnScreen().x + rightClickEvent.getX()),
                                                  (rightClickEvent.getComponent().getLocationOnScreen().y + rightClickEvent.getY()));
    ...
    class D2WayPainterPanel extends JPanel {
        ...
        private Image lEmptyBackground;
        private Image tick;
        private Point[] questLoc = {new Point(36, 59),
                                    new Point(36, 87),
                                    new Point(36, 116),
                                    new Point(36, 145),
                                    new Point(36, 174),
