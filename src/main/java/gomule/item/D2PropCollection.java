        ...
        for (int x = 0; x < size(); x++) {
            ...
            for (int y = 0; y < size(); y++) {
                ...
                if ((((D2Prop) get(x)).getPNum() == ((D2Prop) get(y)).getPNum()) && (((D2Prop) get(x)).getQFlag() == ((D2Prop) get(y)).getQFlag()) && (((D2Prop) get(x)).getQFlag() == 0)) {
                    if (((D2Prop) get(x)).getPNum() == 107 || ((D2Prop) get(x)).getPNum() == 97 || ((D2Prop) get(x)).getPNum() == 188 || ((D2Prop) get(x)).getPNum() == 201 || ((D2Prop) get(x)).getPNum() == 198 || ((D2Prop) get(
                            x)).getPNum() == 204) { continue; }
                ...
                if (x + 2 < size()) {
                    ...
                    if (((D2Prop) get(x)).getPNum() == 57 && ((D2Prop) get(x + 1)).getPNum() == 58 && ((D2Prop) get(x + 2)).getPNum() == 59) {
                        ...
                        if (((D2Prop) get(x + 2)).getPVals().length > 1 && ((D2Prop) get(x + 2)).getPVals()[2] != 0) {
                            ((D2Prop) get(x)).modifyVals(36,
                                                         new int[]{((D2Prop) get(x)).getPVals()[0],
                                                                   ((D2Prop) get(x + 1)).getPVals()[0],
                                                                   ((D2Prop) get(x + 2)).getPVals()[0],
                                                                   ((D2Prop) get(x + 2)).getPVals()[2]});
